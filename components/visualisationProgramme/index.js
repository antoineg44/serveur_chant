    ...
    for(var i=0; i<programme.chants.length; i++)
    {
      if(programme.chants[i].type == "partie") {
        ...
        if(programme.chants[i].name == titre) {
            content += '<div class="nav-button nav-button-left" onclick="manager_open(\'' + path_file_programme.replaceAll("'","%27") + '\',\'' + programme.chants[i].path.replaceAll("'","\'") + '\');" style="color:#fff;background-color:#c9bfff;border-radius: 16px 0 0 16px;"><i class="fas fa-thumbtack"><img src = "../icons/music.png"></i><span>'+programme.chants[i].name.replaceAll("'","\'")+'</span></div>';
        }
        else {
            content += '<div class="nav-button nav-button-left" onclick="manager_open(\'' + path_file_programme.replaceAll("'","%27") + '\',\'' + programme.chants[i].path.replaceAll("'","\'") + '\');" style="color:#fff;border-radius: 16px 0 0 16px;"><i class="fas fa-thumbtack"><img src = "../icons/music.png"></i><span>'+programme.chants[i].name.replaceAll("'","\'")+'</span></div>';
        }
      }
