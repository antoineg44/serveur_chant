...
<body class="h-full w-full"><noscript><strong>Il faut activer le Javascript !!!</strong></noscript>
    ...
    <div class="mx-auto max-w-6xl px-6 lg:px-8" style="margin-top:20px;margin-bottom:20px;">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-4xl font-bold tracking-tight text-white sm:text-4xl">[En construction !] Carnet de chant de la paroisse notre Dame de Nantes :</h2>
            <p class="mt-6 text-lg leading-8 text-gray-300"><a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/carnets/lists/Paroisse NDDN - Carnet de chants 2014.pdf" target="_blank" style="color: #3498db;">Lien vers le carnets de chants</a></p>
            <p class="mt-6 text-lg leading-8 text-gray-300"><a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/carnets/lists/Table des matières - Par thème.pdf" target="_blank" style="color: #3498db;">Lien vers la table des matière par thème</a></p>
        </div>
    <div/>
	...
	<script>
		$(document).ready(function() {
			...
			new DataTable('#chants', {
                ajax: 'lists/paroisse_nantes.json'
            });
