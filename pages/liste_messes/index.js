...
function insert_paroisse(paroisses, programmes) {
    ...
    for(var i=1; i<programmes.length-1;i++) {
        html_programmes += '<div class="bg-white rounded shadow"><div class="flex items-center justify-between p-3 cursor-pointer select-none" style="padding: 2px;" ondblclick="view_programme(this)">\
